...
import { SearchIcon, CheckIcon, Sparkles } from "lucide-react";
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="border px-6 py-3 md:py-3 rounded-full"
    >
      <InputGroup className="border-none  rounded-full bg-white">
