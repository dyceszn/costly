    ...
    <InputGroup className={cn("w-auto", className)}>
      <ComboboxPrimitive.Input
        render={
          <InputGroupInput
            disabled={disabled}
            className="text-center placeholder:text-center" // Centered placeholder text
          />
        }
        {...props}
      />
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent hidden" // Hid trigger
            disabled={disabled}
          >
            <ComboboxTrigger />
          </InputGroupButton>
